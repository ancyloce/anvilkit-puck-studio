...
export const EditorLayout = ({ aiPanel }: EditorLayoutProps) => {
    ...
    return (
        <div className="max-sm:hidden overflow-hidden h-screen">
            <Header />
            <motion.div
                className="relative w-full flex border-r border-neutral-200 dark:border-neutral-800/80 bg-white/60 dark:bg-neutral-950/80 backdrop-blur-md ml-0 h-[calc(100vh-54px)]"
            >
                <Aside></Aside>
                ...
                <div className="border-l border-neutral-200 dark:border-neutral-800/80">
